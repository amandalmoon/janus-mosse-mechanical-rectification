...
def figure7(release,out):
    ...
    for col,mk,lab,lm,llo,lhi,hm,hlo,hhi in [(BLUE,'o',r'$\langle u\rangle$',low.mean_u,low.u_ci_lo,low.u_ci_hi,high.mean_u,high.u_ci_lo,high.u_ci_hi),(VERM,'s',r'$\langle v\rangle$',low.mean_v,low.v_ci_lo,low.v_ci_hi,high.mean_v,high.u_ci_lo if False else high.v_ci_lo,high.v_ci_hi)]:
