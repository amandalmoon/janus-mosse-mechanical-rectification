...
a.set_xlim(-0.05, 3.05); a.set_ylim(0, 3.65)
...
c.set_xlim(-0.05,3.05); c.set_ylim(0, max(margin_u)*1.13)
...
d.set_xlim(-0.05,3.05); d.set_ylim(0, max(mp)*1.12)
