...
def make_figure(release: Path, out: Path) -> None:
    ...
    ax_a.text(0.345, 0.18, 'u', color=GREEN, fontsize=7.3, fontstyle='italic', ha='left', va='center')
    ax_a.text(0.345, -0.36, 'v', color=PURPLE, fontsize=7.3, fontstyle='italic', ha='left', va='center')
    panel_label(ax_a, 'a')
    ...
    ax_b.text(0.708, float(high['mean_u'].iloc[-1]), 'u', color=GREEN, fontsize=7.3, fontstyle='italic', ha='left', va='center')
    ax_b.text(0.708, float(high['mean_v'].iloc[-1]), 'v', color=PURPLE, fontsize=7.3, fontstyle='italic', ha='left', va='center')
    panel_label(ax_b, 'b')
