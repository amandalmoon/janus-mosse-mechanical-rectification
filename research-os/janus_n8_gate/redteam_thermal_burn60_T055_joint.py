...
T=.55;mu,mv=ens(N,20260919,T,60,*orbit)
...
rng=np.random.default_rng(20261055);B=5000;bm=np.empty((B,2))
...
out.to_csv('/mnt/data/janus_n8_gate/redteam_thermal_burn60_T055_joint.csv',index=False);print(out.to_string(index=False))
