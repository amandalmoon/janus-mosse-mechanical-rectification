...
exec(open('/mnt/data/janus_resolve/matched_symmetry_audit.py').read().split('rows=[]')[0])
...
df.to_csv('/mnt/data/janus_resolve/matched_symmetry_final.csv',index=False)
pd.DataFrame([contracts]).to_csv('/mnt/data/janus_resolve/matched_symmetry_final_contracts.csv',index=False)
