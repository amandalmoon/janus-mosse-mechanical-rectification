...
for ti,T in enumerate(TEMPS):
    ...
    pd.DataFrame(rows).to_csv(f'/mnt/data/janus_resolve/free_thermal_cluster_ci_{SET}.csv',index=False)
    pd.DataFrame(allraw).to_csv(f'/mnt/data/janus_resolve/free_thermal_trajectory_raw_{SET}.csv',index=False)
