...
pd.DataFrame(rows).to_csv(str(_RELEASE_ROOT/'data'/'canonical'/'edge_weight_curves.csv'),index=False)
pd.DataFrame(roots).to_csv(str(_RELEASE_ROOT/'data'/'canonical'/'edge_weight_zero_crossings.csv'),index=False)
