...
D.to_csv(str(_RELEASE_ROOT/'data'/'canonical'/'matched_symmetry_static_dynamic.csv'),index=False)
pd.DataFrame([contracts]).to_csv(str(_RELEASE_ROOT/'data'/'canonical'/'matched_symmetry_contracts.csv'),index=False)
